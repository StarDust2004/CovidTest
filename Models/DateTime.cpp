...
{
    this->Date::Set(aDateTime.Date::Year, aDateTime.Date::Month, aDateTime.Date::Day);
    this->Time::Set(aDateTime.Time::Hour, aDateTime.Time::Minute, aDateTime.Time::Second);
    return *this;
}
